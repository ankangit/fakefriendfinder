...
class UsersController extends Controller
{
	...
	public function accessRules()
	{
		return array(
			array('allow',  // allow all users to perform 'index' and 'view' actions
				'actions'=>array('view','create','forgotPassword','resetpassword','fblogin'),
				'users'=>array('*'),
			),
	...
	public function actionCreate()
	{
        ...
        public function actionFblogin(){
            ...
            require_once(Yii::app()->basePath . '/extensions/fbconnect/base_facebook.php');
            require_once(Yii::app()->basePath . '/extensions/fbconnect/facebook.php');
            
            $appid= "169599634635";
            $appsecret= "702a2468f79452dbf13dac2eb56c6214";
